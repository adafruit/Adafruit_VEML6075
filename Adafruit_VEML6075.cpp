...
/*!
    ...
    @param highDynamic Whether to read in normal or high dynamic mode - defaults
   to normal
    @param theWire Optional pointer to the desired TwoWire I2C object. Defaults
   to &Wire
...
boolean Adafruit_VEML6075::begin(veml6075_integrationtime_t itime,
  ...
  Adafruit_I2CRegister ID_Register =
      Adafruit_I2CRegister(i2c_dev, VEML6075_REG_ID, 2);
  uint16_t id;
...
/**************************************************************************/
/*!
    @brief Set the UVI calculation coefficients, see datasheet for some example
   values. We use the default "no cover glass" values if none are specified when
...
*/
/**************************************************************************/
void Adafruit_VEML6075::setCoefficients(float UVA_A, float UVA_B, float UVB_C,
                                        float UVB_D, float UVA_response,
                                        float UVB_response) {
  _uva_a = UVA_A;
  _uva_b = UVA_B;
  _uvb_c = UVB_C;
...
void Adafruit_VEML6075::takeReading(void) {
  ...
  Adafruit_I2CRegister UVA_Register =
      Adafruit_I2CRegister(i2c_dev, VEML6075_REG_UVA, 2);
  Adafruit_I2CRegister UVB_Register =
      Adafruit_I2CRegister(i2c_dev, VEML6075_REG_UVB, 2);
  Adafruit_I2CRegister UVCOMP1_Register =
      Adafruit_I2CRegister(i2c_dev, VEML6075_REG_UVCOMP1, 2);
  Adafruit_I2CRegister UVCOMP2_Register =
      Adafruit_I2CRegister(i2c_dev, VEML6075_REG_UVCOMP2, 2);
